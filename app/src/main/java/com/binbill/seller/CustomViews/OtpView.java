...
public class OtpView extends LinearLayout {
    ...
    private void generateViews(TypedArray styles) {
        if (length > 0) {
            ...
            int textSize = (int) styles.getDimension(R.styleable.OtpView_otpTextSize, getPixels(12));
            int backgroundColor =
                    styles.getColor(R.styleable.OtpView_text_background_color, Color.TRANSPARENT);
            Drawable backgroundDrawable = styles.getDrawable(R.styleable.OtpView_background_drawable);
